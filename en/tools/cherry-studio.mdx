...
description: "Connect Cherry Studio to RuoLi by adding a custom model provider. Covers installation on Windows, macOS, and Linux, plus API URL and key configuration."
---
