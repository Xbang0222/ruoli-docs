...
description: "Connect OpenCode to RuoLi using CC Switch or manual config.jsonc configuration. Includes installation via npm, Homebrew, or curl and API key setup."
---
