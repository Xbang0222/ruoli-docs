...
description: "Connect Google Gemini CLI to RuoLi using CC Switch or manual settings.json configuration. Includes installation via npm and Homebrew and API setup."
---
