---
title: "CC Switch 配置管理工具"
description: "使用 CC Switch 提供的图形化管理界面来一键配置和切换 Claude Code、Codex、Gemini CLI、OpenCode、OpenClaw 等工具的 RuoLi API 连接。无需手动编辑任何配置文件，支持添加多个不同的配置方案并在它们之间快速切换。"
---
